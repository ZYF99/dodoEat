...
public class Frag1_Fragment2 extends PresenterFragment<Function1Contract.Presenter> implements Function1Contract.View {

    public Frag1_Fragment2() {
    ...
    protected int getContentLayoutId() {
        return R.layout.frag1_fragment2;
    }
